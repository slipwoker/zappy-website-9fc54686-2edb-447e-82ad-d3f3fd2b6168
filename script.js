document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        showFieldError(field, name.charAt(0).toUpperCase() + name.slice(1) + ' is required.');
        return false;
      }
      ...
      if (field.hasAttribute('minlength')) {
        ...
        if (value.length < min) {
          showFieldError(field, name.charAt(0).toUpperCase() + name.slice(1) + ' must be at least ' + min + ' characters.');
          return false;
        }
      }
      ...
      if (field.hasAttribute('maxlength')) {
        ...
        if (value.length > max) {
          showFieldError(field, name.charAt(0).toUpperCase() + name.slice(1) + ' must be no more than ' + max + ' characters.');
          return false;
        }
      }
  ...
  const ANIMATION_SELECTORS = '.animate-on-scroll, .feature-card, .pricing-card, .testimonial-card, .section-header, .hero-content';

  const animatableElements = Array.from(document.querySelectorAll(ANIMATION_SELECTORS));
  ...
  if (animatableElements.length > 0) {
    ...
    animatableElements.forEach(function (el, index) {
      ...
      const delay = el.dataset.animationDelay || (index % 4) * 100;
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "GTIM GROUP uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9fc54686-2edb-447e-82ad-d3f3fd2b6168',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9fc54686-2edb-447e-82ad-d3f3fd2b6168';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9fc54686-2edb-447e-82ad-d3f3fd2b6168';
